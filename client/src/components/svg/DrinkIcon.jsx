    ...
    return (
        <SvgIcon {...props}>
            ...
            >
                <g>
                    <path
                        d="M54.255,138.5c0,13.8,11.2,25,25,25h153.7l19.1,86.7h61.4l-28.101-127.1c-2.5-11.5-12.699-19.6-24.399-19.6h-181.7
			c-13.8,0-25,11.2-25,25V138.5z"
                    />
                    <path
                        d="M655.255,152c-0.4-1.9-1.3-4.4-2.7-7.1l-105.2,105.3h84.9l62.9-62.9c-2.7-1.4-5.2-2.3-7.101-2.7
			C671.555,181.2,658.755,168.4,655.255,152z"
                    />
                    <path
                        d="M819.755,261.9c3.8,0,7.7-2.2,9.4-6.2c33.6-80.8-22-222.9-22-222.9S723.455,0,647.955,0c-22.8,0-44.9,3-63.7,10.8
			...
			C813.455,260.5,816.555,261.9,819.755,261.9z"
                    />
                    <path
                        d="M172.755,280.2c-11.8,0-22.8,6-29.3,15.9c-37.4,56.8-59.2,124.9-59.2,198.101c0,144.199,84.6,268.699,206.8,326.5
